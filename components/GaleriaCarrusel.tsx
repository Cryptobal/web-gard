  ...
  return (
    <div className="relative w-full">
      ...
      <div className="relative">
        ...
        {/* Botones de navegación - Ahora con z-index más alto y position:absolute */}
        <button 
          onClick={prevSlide} 
          className="absolute top-1/2 -translate-y-1/2 left-4 z-50 bg-orange-500 hover:bg-orange-600 text-white p-4 rounded-full shadow-lg sm:block hidden"
        ...
        <button 
          onClick={nextSlide}
          className="absolute top-1/2 -translate-y-1/2 right-4 z-50 bg-orange-500 hover:bg-orange-600 text-white p-4 rounded-full shadow-lg sm:block hidden"
          aria-label="Siguiente imagen"
        >
          <ChevronRight size={24} />
        </button>

        {/* Indicadores de posición - Ahora con posición absoluta en la parte inferior */}
