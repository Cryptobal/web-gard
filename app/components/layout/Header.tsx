...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 z-50 w-full h-auto bg-black/60 backdrop-blur-sm">
      <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
        ...
        {isOpen && (
          <motion.div
            ...
            className="fixed inset-0 z-40 bg-black/80 backdrop-blur-md md:hidden pt-20 h-screen"
            role="dialog"
            aria-modal="true"
