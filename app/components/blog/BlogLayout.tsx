      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {showSidebar ? (
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <aside className="w-full lg:w-1/3 lg:pl-8 mt-12 lg:mt-0 lg:border-l lg:border-gray-200 dark:lg:border-gray-800 bg-gray-50 dark:bg-gray-900 p-6 rounded-xl">
              {/* Últimos artículos */}
              <div className="mb-10">
